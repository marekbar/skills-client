...
namespace SkillsAndTasksDesktopClient
{
    ...
    public static class Service
    {
        ...
        {
            MBService.MBServiceClient client = null;
            try
            {
                if (FROM_APP_CONFIG)
                {
                    client = new MBService.MBServiceClient();
                }
                else
                {
        ...
        /// <returns>MBService.MBServiceClient</returns>
        private static MBService.MBServiceClient GetClientWithCertificate()
        {
            ...
            var client = new MBService.MBServiceClient(binding, new EndpointAddress(SERVICE_ADDRESS));
        ...
        /// </summary>
        /// <returns>MBService.MBServiceClient</returns>
        private static MBService.MBServiceClient GetClientWithSSL()
        {
            ...
            return new MBService.MBServiceClient(binding, new EndpointAddress(SERVICE_ADDRESS));
        }
        /// <summary>
